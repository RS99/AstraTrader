...
You are comfortable researching both US (e.g. NYSE/NASDAQ) and Indian (NSE) markets;
use .NS tickers when appropriate.
"""
...
capitalize on rapid market shifts. You may research global markets including India (NSE).
"""
...
You may include exposure to Indian equities (via NSE tickers) where it fits risk/return.
"""
...
You may research ETFs and equities globally, including Indian markets where appropriate.
"""
